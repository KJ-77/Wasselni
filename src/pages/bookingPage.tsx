    ...
    return (
      <div className="container mx-auto px-4 py-20 text-center">
        <Alert variant="destructive">
          ...
          <AlertDescription>
            Ride data not found or ID mismatch. Please go back and select a ride
            again.
          </AlertDescription>
        </Alert>
      </div>
      ...
      <CardContent className="p-6 space-y-6">
        ...
        <div className="space-y-4">
          <div className="flex items-center gap-4">
            <div className="text-emerald-500 font-bold w-12 text-center">
              FROM
            </div>
            <div>
              <p className="font-semibold text-lg">{ride.route.from.name}</p>
              <p className="text-sm text-gray-500">
                {ride.route.from.location}
              </p>
            </div>
            <p className="text-sm font-medium ml-auto">
              {ride.route.departureTime}
            </p>
          </div>
          <div className="pl-6">
            <Separator
              orientation="vertical"
              className="h-8 ml-6 bg-gray-300"
            />
          </div>
          <div className="flex items-center gap-4">
        ...
        <div className="flex items-center gap-4">
          <Avatar className="h-16 w-16 border-2 border-emerald-500">
            <AvatarImage
              src={`https://api.dicebear.com/6.x/initials/svg?seed=${ride.driver.name}`}
          ...
          <div className="flex justify-between items-center mb-2">
            ...
            <div className="flex items-center gap-2">
              <Button
                ...
                disabled={seats <= 1 || bookingStatus === "loading"}
              >
                -
              </Button>
              ...
              <Button
                ...
                disabled={
                  seats >= availableSeats || bookingStatus === "loading"
                }
              >
                +
              </Button>
        ...
        <div className="space-y-2 text-sm">
          <div className="flex justify-between">
            <p className="text-gray-600 dark:text-gray-300">
              ${ride.price.amount.toFixed(2)} x {seats} seats
            </p>
